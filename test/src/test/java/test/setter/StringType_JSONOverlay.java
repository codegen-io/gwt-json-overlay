...
public final class StringType_JSONOverlay implements StringType {
  ...
  public static StringType wrap(Object object) {
    ...
    throw new IllegalArgumentException("Object '" + object + "' isn't of type test.setter.StringType_JSONOverlay.JsObject");
  }
  ...
  public static JsObject unwrap(Object object) {
    ...
    throw new IllegalArgumentException("Object '" + object + "' isn't of type test.setter.StringType_JSONOverlay");
  }
